...
sys.path.append('/home/kou/mypilot')

try:
    from openpilot.common.params import Params
except ImportError:
    print("Error: Could not import openpilot.common.params")
    print("Make sure mypilot is properly installed in /home/kou/mypilot")
    sys.exit(1)
...
if __name__ == "__main__":
    ...
    if not (os.path.exists('/home/kou/mypilot') or os.path.exists(os.path.expanduser('~/.comma'))):
